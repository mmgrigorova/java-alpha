 ...
 * <p>
 * Find the sum of the digit's patterns in a NxN matrix. This version has all checks in the loop for performance
 * purposes. File Digits.java has a more readable version of the code.
 */

public class DigitsUgly {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                ...
                if (matrix[i][j] == 1 && i >= 2 && i + 2 < n && j + 2 < n) {
                    if (matrix[i - 1][j + 1] == 1
                            && matrix[i + 2][j + 2] == 1
                            && matrix[i - 2][j + 2] == 1
                            && matrix[i - 1][j + 2] == 1
                            ...
                            && matrix[i + 1][j + 2] == 1)
                        result += 1;
                } else if (matrix[i][j] == 2 && i >= 1 && i + 3 < n && j + 2 < n) {
                    if (matrix[i - 1][j + 1] == 2
                            && matrix[i + 3][j + 2] == 2
                            && matrix[i][j + 2] == 2
                            && matrix[i + 1][j + 2] == 2
